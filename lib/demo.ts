...
export function demoMail(now: Date): MailItem[] {
  ...
  return [
    m("prof", SCHOOL, "김지훈 교수", "과제 3 제출 형식 안내", "코드와 보고서를 하나의 zip 파일로 묶어 제출하세요.", 40, { important: true }),
    m("office", SCHOOL, "학사지원팀", "[필독] 2학기 수강 정정 기간 안내", "수강 정정은 이번 주 금요일 오후 6시까지 가능합니다.", 130, { important: true }),
    m("club", CLUB, "동아리 회장", "오늘 회의 안건 공유", "회의 전에 안건 문서를 한 번 읽어 와 주세요.", 200, { important: true }),
